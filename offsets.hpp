// Roblox Version: version-3c1b78b767674c66
// Byfron Version: ???
namespace offsets {
    ...
    inline constexpr uintptr_t DataModelDeleterPointer = 0x692B7A0;
    ...
    inline constexpr uintptr_t FakeDataModelPointer = 0x692B798;
    ...
    inline constexpr uintptr_t HumanoidState = 0x800;
    ...
    inline constexpr uintptr_t JobsPointer = 0x69EA860;
    ...
    inline constexpr uintptr_t MouseSensitivity = 0x69a08e4;
    ...
    inline constexpr uintptr_t PlayerConfigurerPointer = 0x690ADF0;
    ...
    inline constexpr uintptr_t RunContext = 0x11C;
    ...
    inline constexpr uintptr_t TaskSchedulerPointer = 0x69EA688;
    ...
    inline constexpr uintptr_t VisualEnginePointer = 0x6777878;
    ...
    inline constexpr uintptr_t WhitelistEncryption = 0xA6FC287E;
    inline constexpr uintptr_t WhitelistEncryption2 = 0xF6;
    inline constexpr uintptr_t WhitelistSetInsert = 0xD78CD0;
    inline constexpr uintptr_t WhitelistedPages = 0x2830C8;
    inline constexpr uintptr_t WhitelistedThreads = 0x29A130;
