// Roblox Version: version-347f4ac346734391
// Byfron Version: ???
namespace offsets {
    ...
    inline constexpr uintptr_t CharacterAppearanceId = 0x220;
    ...
    inline constexpr uintptr_t ClockTime = 0x5AF0;
    inline constexpr uintptr_t CreatorId = 0x168;
    inline constexpr uintptr_t DataModelDeleterPointer = 0x61EB420;
    ...
    inline constexpr uintptr_t EvaluateStateMachine = 0x1D7;
    inline constexpr uintptr_t FOV = 0x160;
    inline constexpr uintptr_t FakeDataModelPointer = 0x61EB418;
    ...
    inline constexpr uintptr_t Job_Name = 0x150;
    inline constexpr uintptr_t JobsPointer = 0x62A1990;
    ...
    inline constexpr uintptr_t MouseSensitivity = 0x62599F4;
    ...
    inline constexpr uintptr_t PlayerConfigurerPointer = 0x618C670;
    ...
    inline constexpr uintptr_t TaskSchedulerPointer = 0x62A17B8;
    inline constexpr uintptr_t Team = 0x210;
    ...
    inline constexpr uintptr_t UserId = 0x230;
    ...
    inline constexpr uintptr_t VisualEnginePointer = 0x5FFA5E0;
