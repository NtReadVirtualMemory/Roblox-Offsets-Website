...
namespace offsets {
    ...
    inline constexpr uintptr_t DataModelDeleterPointer = 0x651E3C0;
    ...
    inline constexpr uintptr_t FakeDataModelPointer = 0x651E3B8;
    ...
    inline constexpr uintptr_t Gravity = 0x8D0;
    ...
    inline constexpr uintptr_t JobsPointer = 0x65DE0F0;
    ...
    inline constexpr uintptr_t ModelInstance = 0x2F0;
    ...
    inline constexpr uintptr_t MouseSensitivity = 0x6593dd4;
    ...
    inline constexpr uintptr_t PlayerConfigurerPointer = 0x64FDC08;
    ...
    inline constexpr uintptr_t TaskSchedulerPointer = 0x65DDF18;
    ...
    inline constexpr uintptr_t VisualEnginePointer = 0x636BDE8;
    ...
    inline constexpr uintptr_t WhitelistEncryption = 0x1BCEC215;
    inline constexpr uintptr_t WhitelistEncryption2 = 0x6B;
    inline constexpr uintptr_t WhitelistSetInsert = 0xE15010;
    inline constexpr uintptr_t WhitelistedPages = 0x2730a8;
    inline constexpr uintptr_t WhitelistedThreads = 0x291B68;
    inline constexpr uintptr_t Bitmap = 0x29AA80;
