// Roblox Version: version-9bf2d7ce6a0345d5
// Byfron Version: ???
namespace offsets {
    ...
    inline constexpr uintptr_t DataModelDeleterPointer = 0x675AA40;
    ...
    inline constexpr uintptr_t FakeDataModelPointer = 0x675AA38;
    ...
    inline constexpr uintptr_t JobsPointer = 0x681CBF0;
    ...
    inline constexpr uintptr_t MouseSensitivity = 0x67D20C4;
    ...
    inline constexpr uintptr_t PlayerConfigurerPointer = 0x6739D08;
    ...
    inline constexpr uintptr_t TaskSchedulerPointer = 0x681CA18;
    ...
    inline constexpr uintptr_t VisualEnginePointer = 0x659F348;
    ...
    inline constexpr uintptr_t WhitelistEncryption = 0xE852B98E;
    inline constexpr uintptr_t WhitelistEncryption2 = 0xD7;
    inline constexpr uintptr_t WhitelistSetInsert = 0xD0D0F0;
    inline constexpr uintptr_t WhitelistedPages = 0x2A5A70;
    inline constexpr uintptr_t WhitelistedThreads = 0x2A3128;
