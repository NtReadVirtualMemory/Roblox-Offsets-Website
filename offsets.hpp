// Roblox Version: version-e1da58b32b1c4d64
// Byfron Version: ???
namespace offsets {
    ...
    inline constexpr uintptr_t ClockTime = 0xA778;
    inline constexpr uintptr_t CreatorId = 0x190;
    inline constexpr uintptr_t DataModelDeleterPointer = 0x6726240;
    ...
    inline constexpr uintptr_t FakeDataModelPointer = 0x6726238;
    ...
    inline constexpr uintptr_t JobsPointer = 0x67E7920;
    ...
    inline constexpr uintptr_t MouseSensitivity = 0x679d694;
    ...
    inline constexpr uintptr_t PlayerConfigurerPointer = 0x6705A28;
    ...
    inline constexpr uintptr_t TaskSchedulerPointer = 0x67E7748;
    ...
    inline constexpr uintptr_t VisualEnginePointer = 0x65719A8;
    ...
    inline constexpr uintptr_t WhitelistEncryption = 0x9C19A3DF;
    inline constexpr uintptr_t WhitelistEncryption2 = 0x49;
    inline constexpr uintptr_t WhitelistSetInsert = 0xE63000;
    inline constexpr uintptr_t WhitelistedPages = 0x2D5C28;
    inline constexpr uintptr_t WhitelistedThreads = 0x2D6360;
